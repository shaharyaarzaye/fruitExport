          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img 
                ...
                alt="Ashirwad Enterprises" 
                className="w-full h-auto"
              />
            </div>
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-slate-900 font-serif">Welcome to Ashirwad Enterprises</h2>
              <div className="w-20 h-1 bg-yellow-500"></div>
              <p className="text-slate-600 leading-relaxed">
                Established in 2015, Ashirwad Enterprises has grown to become one of the most trusted names in exporting premium Indian agricultural products across the globe.
              </p>
              <p className="text-slate-600 leading-relaxed">
            ...
            <div>
              ...
              <div className="border-l-4 border-yellow-500 pl-8 space-y-4">
                <p className="text-2xl italic text-slate-700 font-light leading-relaxed">
                  "Our journey began with a simple belief — deliver the authentic taste and quality of India to every corner of the world. Today, with blessings (Ashirwad) of thousands of farmers and trust of customers globally, we continue to grow with honesty and hard work."
                </p>
                <div className="pt-6">
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-xl shadow-sm border border-gray-100">
               <p className="text-slate-600 italic mb-8 leading-relaxed">
                 "Consistent quality for 5 years. Ashirwad is our only rice partner now."
               </p>
