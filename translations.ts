...
export const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    hero_welcome: 'Welcome to Ashirwad Enterprises',
    ...
    feature_title: 'Why Choose Ashirwad Enterprises?', gallery_title: 'Photo Gallery', contact_title: 'Contact Us', about_title: 'About Us'
  },
  ar: {
    ...
    hero_welcome: 'مرحباً بكم في أشيرواد إنتربرايزس',
    ...
    feature_title: 'لماذا تختار أشيرواد إنتربرايزس؟', gallery_title: 'معرض الصور', contact_title: 'اتصل بنا', about_title: 'من نحن'
  },
  zh: {
    nav_home: '首页', nav_about: '关于我们', nav_products: '产品', nav_gallery: '图库', nav_contact: '联系我们', nav_select_lang: '选择语言',
    hero_welcome: '欢迎来到 Ashirwad Enterprises',
    ...
    feature_title: '为什么选择 Ashirwad Enterprises？', gallery_title: '相册', contact_title: '联系我们', about_title: '关于我们'
  },
  hi: {
    ...
    hero_welcome: 'आशीर्वाद एंटरप्राइजेज में आपका स्वागत है',
    ...
    feature_title: 'आशीर्वाद एंटरप्राइजेज क्यों चुनें?', gallery_title: 'फोटो गैलरी', contact_title: 'संपर्क करें', about_title: 'हमारे बारे में'
  },
  fr: {
    ...
    hero_welcome: 'Bienvenue chez Ashirwad Enterprises',
    ...
    feature_title: 'Pourquoi choisir Ashirwad Enterprises ?', gallery_title: 'Galerie Photos', contact_title: 'Contactez-nous', about_title: 'À propos de nous'
  },
  de: {
    ...
    hero_welcome: 'Willkommen bei Ashirwad Enterprises',
    ...
    feature_title: 'Warum Ashirwad Enterprises wählen?', gallery_title: 'Fotogalerie', contact_title: 'Kontaktieren Sie uns', about_title: 'Über uns'
  },
  ja: {
    nav_home: 'ホーム', nav_about: '会社概要', nav_products: '製品', nav_gallery: 'ギャラリー', nav_contact: 'お問い合わせ', nav_select_lang: '言語を選択',
    hero_welcome: 'アシルワッド・エンタープライズへようこそ',
    ...
    feature_title: 'アシルワッド・エンタープライズを選ぶ理由', gallery_title: 'フォトギャラリー', contact_title: 'お問い合わせ', about_title: '私たちについて'
  },
  pt: {
    ...
    hero_welcome: 'Bem-vindo à Ashirwad Enterprises',
    ...
    feature_title: 'Por que escolher a Ashirwad Enterprises?', gallery_title: 'Galeria de Fotos', contact_title: 'Contate-nos', about_title: 'Sobre Nós'
  },
  ru: {
    ...
    hero_welcome: 'Добро пожаловать в Ashirwad Enterprises',
    ...
    feature_title: 'Почему выбирают Ashirwad Enterprises?', gallery_title: 'Фотогалерея', contact_title: 'Связаться с нами', about_title: 'О нас'
  },
  es: {
    ...
    hero_welcome: 'Bienvenido a Ashirwad Enterprises',
    ...
    feature_title: '¿Por qué elegir Ashirwad Enterprises?', gallery_title: 'Galería de fotos', contact_title: 'Contáctenos', about_title: 'Sobre nosotros'
  }
};
